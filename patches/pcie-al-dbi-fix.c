...
static int al_pcie_probe(struct platform_device *pdev)
{
	...
	/*
	 * On Alpine V2, the DWC DBI registers are at offset 0x10000 from
	 * the controller base (i.e. controller_base + 64KB). Pre-set
	 * dbi_base so dw_pcie_get_resources() skips the "dbi" resource
	 * lookup and avoids a resource conflict.
	 */
